import typing
from typing import AbstractSet, Any, Callable, ClassVar, Iterable, Iterator, Mapping, NoReturn
...
class ImmutableDictBase(ReadOnlyContainer, dict, typing.Generic):
...
class immutabledict(ImmutableDictBase):
    __orig_bases__: ClassVar[tuple] = ...
    __parameters__: ClassVar[tuple] = ...
    def __init__(self, *args: Mapping[_KT, _VT] | Iterable[tuple[_KT, _VT]]) -> None: ...
    def __reduce__(self): ...
    def union(self, _immutabledict__d: Mapping[_KT, _VT] | None = ...) -> immutabledict[_KT, _VT]: ...
    def merge_with(self, *dicts: Mapping[_KT, _VT] | None) -> immutabledict[_KT, _VT]: ...
    def __ior__(self, _immutabledict__value: Any) -> NoReturn: ...
    def __or__(self, _immutabledict__value: Mapping[_KT, _VT]) -> immutabledict[_KT, _VT]: ...
    def __ror__(self, _immutabledict__value: Mapping[_KT, _VT]) -> immutabledict[_KT, _VT]: ...

class OrderedSet(set, typing.Generic):
    __orig_bases__: ClassVar[tuple] = ...
    __parameters__: ClassVar[tuple] = ...
...
def unique_list(seq: Iterable[_T], hashfunc: Callable[[_T], int] | None = ...) -> list[_T]: ...
