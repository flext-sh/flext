...
class QueryPropertyDescriptor(typing.Protocol):
...
class scoped_session(typing.Generic):
    ...
    def __init__(self, session_factory: sessionmaker[_S], scopefunc: Callable[[], Any] | None = ...) -> None: ...
    def __call__(self, **kw: Any) -> _S: ...
    def configure(self, **kwargs: Any) -> None: ...
    def remove(self) -> None: ...
    def query_property(self, query_cls: type[Query[_T]] | None = ...) -> QueryPropertyDescriptor: ...
...
class ScopedSession(typing.Generic):
    _support_async: ClassVar[bool] = ...
    __orig_bases__: ClassVar[tuple] = ...
    __parameters__: ClassVar[tuple] = ...
    bind: Incomplete
