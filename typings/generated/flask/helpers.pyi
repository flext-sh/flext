...
def send_file(path_or_file: os.PathLike[t.AnyStr] | str | t.IO[bytes], mimetype: str | None = ..., as_attachment: bool = ..., download_name: str | None = ..., conditional: bool = ..., etag: bool | str = ..., last_modified: datetime | float | None = ..., max_age: None | int | t.Callable[[str | None], int | None] = ...) -> Response: ...
