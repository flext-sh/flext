...
from typing import Any, Context, EventDict, Generator, Iterator, WrappedLogger

def wrap_dict(dict_class: type[Context]) -> type[Context]: ...

TLLogger: typing.TypeVar
def as_immutable(logger: TLLogger) -> TLLogger: ...
def tmp_bind(*args, **kwds) -> Generator[TLLogger, None, None]: ...
...
def bound_threadlocal(*args, **kwds) -> Generator[None, None, None]: ...
