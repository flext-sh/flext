...
class Metrics:
    ...
    def note_skipped_test(self, num=...):  # -> None:
    ...
    def count_locs(self, lines):  # -> None:
        """Count lines of code.
    ...
    def count_issues(self, scores):  # -> None:
        ...
