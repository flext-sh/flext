...
class FFI:
    ...
    type CType = _tmp_CType
    type buffer = _tmp_buffer
    ...
    if sys.platform == "win32": ...
        ...
        def dlopen(
            self, libpath: str | CData | None = ..., flags: int = ..., /
        ) -> Lib: ...
    ...
    @overload
    def from_buffer(
        self, cdecl: WriteableBuffer, require_writable: Literal[True]
    ) -> CData: ...
    @overload
    def from_buffer(
        self,
    ...
    def from_buffer(
        self,
        cdecl: str | CType,
        python_buffer: WriteableBuffer,
        require_writable: Literal[True],
    ) -> CData: ...
    def from_handle(self, x: CData, /) -> Any: ...
    @overload
    def gc(
        self, cdata: CData, destructor: Callable[[CData], Any], size: int = ...
    ) -> CData: ...
    @overload
...
if sys.platform == "win32": ...
    ...
    def load_library(
        libpath: str | _CDataBase | None = ..., flags: int = ..., /
    ) -> CLibrary: ...
