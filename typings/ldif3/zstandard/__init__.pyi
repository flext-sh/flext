import os
from collections.abc import ByteString, Generator, Iterable
from typing import (
    IO,
    BinaryIO,
    Self,
...
class BufferWithSegments:
    size: int
    def __init__(self, data: ByteString, segments: ByteString) -> None: ...
    def __len__(self) -> int: ...
    def __getitem__(self, i: int) -> BufferSegment: ...
    def segments(self): ...
    def tobytes(self) -> bytes: ...
...
class ZstdCompressionDict:
    ...
    d: int
    def __init__(
        self, data: ByteString, dict_type: int = ..., k: int = ..., d: int = ...
    ) -> None: ...
    def __len__(self) -> int: ...
    def dict_id(self) -> int: ...
    def as_bytes(self) -> bytes: ...
    def precompute_compress(
        self, level: int = ..., compression_params: ZstdCompressionParameters = ...
    ): ...
...
class ZstdCompressor:
    ...
    def multi_compress_to_buffer(
        self,
        data: BufferWithSegments | BufferWithSegmentsCollection | list[ByteString],
        threads: int = ...,
...
class ZstdDecompressor:
    ...
    def decompressobj(
        self, write_size: int = ..., read_across_frames: bool = ...
    ...
    def multi_decompress_to_buffer(
        self,
        frames: BufferWithSegments | BufferWithSegmentsCollection | list[ByteString],
...
def get_frame_parameters(
    data: ByteString, format: int | None = ...
) -> FrameParameters: ...
...
def open(
    filename: bytes | str | os.PathLike | BinaryIO,
    mode: str = ...,
    cctx: ZstdCompressor | None = ...,
    dctx: ZstdDecompressor | None = ...,
    encoding: str | None = ...,
    errors: str | None = ...,
    newline: str | None = ...,
    closefd: bool = ...,
