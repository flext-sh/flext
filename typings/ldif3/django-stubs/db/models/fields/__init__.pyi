...
from typing import Any, Generic, NoReturn, Self, TypeVar, overload, type_check_only
...
class ForwardManyToOneDescriptor[F: Field]:
    field: _F
...
class ReverseOneToOneDescriptor[From: Model, To: Model]:
    related: OneToOneRel
    ...
    @overload
    def __get__(
        self, instance: None, cls: Any | None = ...
...
class ReverseManyToOneDescriptor[To: Model]:
    rel: ManyToOneRel
    ...
    @overload
    def __get__(
        self, instance: Model, cls: Any | None = ...
    ) -> RelatedManager[_To]: ...
    def __set__(self, instance: Any, value: Any) -> NoReturn: ...

@type_check_only
class RelatedManager[To: Model](Manager[To]):
...
def create_reverse_many_to_one_manager[M: Model](
...
class ManyRelatedManager(Manager[_To], Generic[_To, _Through]):
    ...
    def add(
        self, *objs: _To | int, through_defaults: Mapping[str, Any] | None = ...
    ) -> None: ...
    async def aadd(
        self, *objs: _To | int, through_defaults: Mapping[str, Any] | None = ...
    ) -> None: ...
    ...
    def create(
        self, *, through_defaults: Mapping[str, Any] | None = ..., **kwargs: Any
    ) -> _To: ...
    async def acreate(
        self, *, through_defaults: Mapping[str, Any] | None = ..., **kwargs: Any
    ) -> _To: ...
...
def create_forward_many_to_many_manager[To: Model](
