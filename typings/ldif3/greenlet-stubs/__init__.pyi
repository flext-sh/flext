...
type _TraceEvent = Literal["switch", "throw"]
type _TraceCallback = Callable[[_TraceEvent, tuple[greenlet, greenlet]], object]
CLOCKS_PER_SEC: int
...
class _ParentDescriptor(Protocol):
    def __get__(
        self, obj: greenlet, owner: type[greenlet] | None = ...
    ) -> greenlet | None: ...
...
class greenlet:
    ...
    def __init__(
        self, run: Callable[..., Any] | None = ..., parent: greenlet | None = ...
    ) -> None: ...
