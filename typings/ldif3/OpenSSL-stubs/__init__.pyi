...
type _Key = DSAPrivateKey | DSAPublicKey | RSAPrivateKey | RSAPublicKey
FILETYPE_PEM: int
FILETYPE_ASN1: int
FILETYPE_TEXT: int
TYPE_RSA: int
...
class X509Store:
    ...
    def load_locations(
        self, cafile: StrOrBytesPath, capath: StrOrBytesPath | None = ...
    ) -> None: ...
...
class X509StoreContext:
    def __init__(
        self, store: X509Store, certificate: X509, chain: Sequence[X509] | None = ...
    ) -> None: ...
...
def load_privatekey(
    type: int, buffer: str | bytes, passphrase: bytes | Callable[[], bytes] | None = ...
) -> PKey: ...
