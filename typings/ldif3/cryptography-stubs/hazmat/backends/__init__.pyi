...
class DERSerializationBackend(ABC):
    @abstractmethod
...
class EllipticCurveBackend(ABC):
    @abstractmethod
...
class PEMSerializationBackend(ABC):
    @abstractmethod
