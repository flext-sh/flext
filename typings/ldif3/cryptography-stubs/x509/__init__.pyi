...
class Name:
    ...
    def __init__(
        self, attributes: Sequence[NameAttribute | RelativeDistinguishedName]
    ) -> None: ...
    def __iter__(self) -> Generator[NameAttribute]: ...
...
class IPAddress(GeneralName):
    ...
    def __init__(
        self, value: IPv4Address | IPv6Address | IPv4Network | IPv6Network
    ) -> None: ...
...
class Extension[T: ExtensionType]:
    @property
...
class AuthorityKeyIdentifier(ExtensionType):
    ...
    def from_issuer_subject_key_identifier(
        cls: type[Self], ski: SubjectKeyIdentifier
    ) -> Self: ...
...
def load_der_x509_certificate(
    data: bytes, backend: X509Backend | None = ...
) -> Certificate: ...
