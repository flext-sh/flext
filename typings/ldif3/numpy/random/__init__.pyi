...
class RandomState:
    ...
    @overload
    def randint(self, low: int, high: int | None = ..., size: None = ...) -> int: ...
    @overload
    def randint(
        self,
        low: int,
    ...
    @overload
    def randint(
        self, low: int, high: int | None = ..., size: None = ..., dtype: type[int] = ...
    ) -> int: ...
    @overload
    def randint(
        self,
    ...
    @overload
    def standard_gamma(
        self, shape: _ArrayLikeFloat_co, size: _ShapeLike | None = ...
    ) -> NDArray[float64]: ...
    @overload
