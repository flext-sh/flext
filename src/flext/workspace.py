...
class WorkspaceManager:
    ...
    def _discover_projects(self) -> list[Path]:
        ...
        Discovery Rules:
            ...
            - Specialized: algar-oud-mig, gruponos-meltano-native
        ...
        for item in self.workspace_root.iterdir():
            ...
            elif item.name in ["algar-oud-mig", "gruponos-meltano-native"]:
                pyproject = item / "pyproject.toml"
                if pyproject.exists():
                    projects.append(item)
    ...
    def get_project_info(self, project_name: str) -> dict[str, str] | None:
        ...
        Project Types:
            ...
            - 'specialized': Custom implementations (algar, gruponos)
