...
| `r[U].fail(error)`     | `fail[U](cls, error: str \                                             | None, error_code: str \                            | None = None, error_data: m.Tests.ResultErrorDataModel \ | None = None) -> p.Result[U]` | Create failure with message, optional code and metadata |
...
class UserModel(m.ArbitraryTypesModel):
    ...
    user_id: Annotated[t.NonEmptyStr, u.Field(description="User ID")]
