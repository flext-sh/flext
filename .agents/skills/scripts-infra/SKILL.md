...
- Legacy scripts (deprecated):
  ...
  - `.agents/skills/scripts-infra/validate_ownership.py`
  - `.agents/skills/scripts-infra/validate_artifact_naming.py`
...
- Every script owned by this skill must have `# Owner-Skill: .agents/skills/scripts-infra/SKILL.md` in its header.
...
- Skill-specific validation/fix logic must live in `.agents/skills/<skill>/` scripts.
...
5. Run `python .agents/skills/scripts-infra/validate_ownership.py --root .` to verify ownership markers.
...
- `python .agents/skills/scripts-infra/validate_ownership.py --root .`
...
| `.agents/skills/scripts-infra/validate_ownership.py`       | Ownership validator (hard gate)                             | `python .agents/skills/scripts-infra/validate_ownership.py --root .`       |
| `.agents/skills/scripts-infra/validate_artifact_naming.py` | Artifact naming validator                                   | `python .agents/skills/scripts-infra/validate_artifact_naming.py --root .` |
