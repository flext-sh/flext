...
def main() -> None:
    ...
    files_with_issues = [
        ...
        # client-a-oud-mig files
        "client-a-oud-mig/tests/unit/test_domain_types.py",
        "client-a-oud-mig/tests/unit/test_handlers.py",
        "client-a-oud-mig/tests/unit/test_idempotent_migration_service.py",
        "client-a-oud-mig/tests/unit/test_oud_connection_service.py",
        "client-a-oud-mig/tests/unit/test_schema_service.py",
        "client-a-oud-mig/tests/unit/test_services.py",
        # client-b-meltano-native files
        "client-b-meltano-native/src/client-b_meltano_native/orchestrator.py",
        "client-b-meltano-native/tests/unit/test_basic_integration.py",
    ]
