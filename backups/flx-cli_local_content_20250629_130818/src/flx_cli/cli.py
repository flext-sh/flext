"""FLX CLI Entry Point - Main command-line interface.
...
from flx_cli.commands import auth, config, debug, pipeline, plugin
from flx_cli.utils.output import setup_console
...
@click.version_option(version="0.1.0", prog_name="flx")
@click.option(
    "--profile",
    default="default",
    envvar="FLX_PROFILE",
...
def interactive(ctx: click.Context) -> None:
    ...
    console.print("Use 'flx --help' for available commands.")
...
def version(ctx: click.Context) -> None:
    ...
    console = ctx.obj["console"]
    console.print("FLX CLI version 0.1.0")
