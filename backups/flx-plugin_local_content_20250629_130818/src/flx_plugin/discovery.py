...
class PluginDiscovery:
    ...
    async def discover_plugins(
        self, plugin_types: Sequence[PluginType] | None = None, refresh_cache: bool = False
            ...
            for entry_point in entry_points:
                try:
                    ...
                    if validation_result.is_ok():
                        ...
                        failed_discoveries[plugin_entry.name] = validation_result.error.message
                        self.logger.warning(
    ...
    def _create_plugin_entry_point(self, entry_point: importlib.metadata.EntryPoint) -> PluginEntryPoint:
    ...
    async def _validate_plugin_entry(self, plugin_entry: PluginEntryPoint) -> ServiceResult[bool]:
    ...
    def _validate_plugin_module(self, module: object, plugin_entry: PluginEntryPoint) -> tuple[bool, str]:
