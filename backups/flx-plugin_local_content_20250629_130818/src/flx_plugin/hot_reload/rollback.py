...
from flx_plugin.hot_reload.state_manager import StateManager, StateSnapshot
...
class RollbackManager:
    ...
    async def _backup_plugin_code(
        ...
        if not plugin_module or not hasattr(plugin_module, "__file__"):
            raise ValueError(f"Cannot determine plugin module file")
