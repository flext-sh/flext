...
class RoleBasedAuthorizationService(AuthorizationService):
    ...
    def _get_derived_permissions(self, permission: Permission) -> set[str]:
        ...
        # Permission hierarchy: admin > manage > write > read
...
class DefaultRoleManager:
    ...
    def create_admin_role(cls) -> Role:
        ...
        permissions = [
            Permission.create("admin_users", PermissionScope.ADMIN, "users"),
            Permission.create("admin_pipelines", PermissionScope.ADMIN, "pipelines"),
            Permission.create("admin_plugins", PermissionScope.ADMIN, "plugins"),
            Permission.create("admin_system", PermissionScope.ADMIN, "system"),
            Permission.create("admin_config", PermissionScope.ADMIN, "config"),
