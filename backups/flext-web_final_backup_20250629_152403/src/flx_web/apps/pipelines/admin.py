...
This module configures the Django admin interface for managing pipelines,
...
from flx_web.models import Execution, PipelineWeb, PluginWeb


@admin.register(PipelineWeb)
class PipelineAdmin(admin.ModelAdmin):
    """Django admin configuration for Pipeline model.

    Provides a comprehensive admin interface for managing data pipelines
...
class ExecutionAdmin(admin.ModelAdmin):
    """Django admin configuration for Execution model.
...
@admin.register(PluginWeb)
class PluginAdmin(admin.ModelAdmin):
    """Django admin configuration for Plugin model.
