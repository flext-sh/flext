...
class UserService(AuthenticationServiceProtocol):
    ...
    async def refresh_tokens(
        self, refresh_token: JWTToken, ip_address: IPAddress | None = None, user_agent: UserAgent | None = None
    ...
    async def change_password(
        self, user_id: UserID, old_password: PlaintextPassword, new_password: PlaintextPassword
    ) -> bool:
