...
async def validate_migration():
    # Old API
    old_ldap = LDAP.connect_to("server.com", "admin", "secret")
...
- [ ] Update to latest flx-ldap version
...
is_admin = await session.is_user_in_group("john.doe", "Admins")
