...
OBJETIVO: Interface unificada e LIMPA para TODA a funcionalidade flx-ldap
=================================================================================
...
class AdminOps:
    """🛠️ Operações administrativas organizadas."""
