...
if CLICK_AVAILABLE:
    ...
    def schema2ldif_command(
        ...
        Examples:
          ...
          $ flx-ldap schema2ldif input.schema output.ldif

          Convert with validation:
          $ flx-ldap schema2ldif -V input.schema output.ldif

          Pretty-print output:
          $ flx-ldap schema2ldif -p input.schema output.ldif
    ...
    def ldap_schema_manager_command(
        ...
        Examples:
          ...
          $ flx-ldap ldap-schema-manager install -f custom.ldif

          List installed schemas:
          $ flx-ldap ldap-schema-manager list -s ldap://server

          Remove schema:
          $ flx-ldap ldap-schema-manager remove -n custom

          Validate schema file:
          $ flx-ldap ldap-schema-manager validate -f schema.ldif
    ...
    def asn1_tool_command(
        ...
        Examples:
          Decode ASN.1 file:
          $ flx-ldap asn1-tool decode -i data.der -o data.txt

          Encode data:
          $ flx-ldap asn1-tool encode -i data.txt -o data.der

          Dump ASN.1 structure:
          $ flx-ldap asn1-tool dump -i data.der
    ...
    def sasl_test_command(
        ...
        Examples:
          ...
          $ flx-ldap sasl-test -m PLAIN -u user -P

          Test DIGEST-MD5:
          $ flx-ldap sasl-test -m DIGEST-MD5 -u user -r example.com

          Interactive testing:
          $ flx-ldap sasl-test -m DIGEST-MD5 -I
