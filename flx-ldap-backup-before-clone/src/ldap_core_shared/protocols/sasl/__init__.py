...
Usage Example:
    >>> from ldap_core_shared.protocols.sasl import SASLClient, SASLCallbackHandler
    >>>
    >>> # Create SASL client
...
try:
    from ldap_core_shared.protocols.sasl.callback import (  # type: ignore[import-not-found]
        AuthorizeCallback,
        NameCallback,
        PasswordCallback,
        RealmCallback,
    ...
    from ldap_core_shared.protocols.sasl.client import (  # type: ignore[import-not-found]
        SASLClient,
        SASLClientFactory,
    )
    from ldap_core_shared.protocols.sasl.context import (  # type: ignore[import-not-found]
        SASLContext,
        SASLProperties,
        SASLSecurityLayer,
    )
    from ldap_core_shared.protocols.sasl.exceptions import (  # type: ignore[import-not-found]
        SASLAuthenticationError,
        SASLError,
        SASLInvalidMechanismError,
        SASLSecurityError,
    )
    from ldap_core_shared.protocols.sasl.mechanism import (  # type: ignore[import-not-found]
        SASLMechanism,
        SASLMechanismRegistry,
    )
    from ldap_core_shared.protocols.sasl.mechanisms.anonymous import (  # type: ignore[import-not-found]
        AnonymousMechanism,
    )
    from ldap_core_shared.protocols.sasl.mechanisms.digest_md5 import (  # type: ignore[import-not-found]
        DigestMD5Mechanism,
    )
    from ldap_core_shared.protocols.sasl.mechanisms.external import (  # type: ignore[import-not-found]
        ExternalMechanism,
    )
    from ldap_core_shared.protocols.sasl.mechanisms.plain import (  # type: ignore[import-not-found]
        PlainMechanism,
    )
    from ldap_core_shared.protocols.sasl.server import (  # type: ignore[import-not-found]
        SASLServer,
        SASLServerFactory,
    )
...
def new(mechanism: str | list[str] | None = None, **options: object):
    ...
    Example:
        >>> import ldap_core_shared.protocols.sasl as sasl
        >>>
