...
// --- wrapping struct: meltano.ProjectInfo ---
//
extern long long int meltano_ProjectInfo_CTor();
extern char* meltano_ProjectInfo_Name_Get(long long int handle);
extern void meltano_ProjectInfo_Name_Set(long long int handle, char* val);
extern char* meltano_ProjectInfo_Path_Get(long long int handle);
extern void meltano_ProjectInfo_Path_Set(long long int handle, char* val);
extern char* meltano_ProjectInfo_Environment_Get(long long int handle);
extern void meltano_ProjectInfo_Environment_Set(long long int handle, char* val);

// --- wrapping struct: meltano.Result ---
//
extern long long int meltano_Result_CTor();
extern char meltano_Result_Success_Get(long long int handle);
extern void meltano_Result_Success_Set(long long int handle, char val);
extern char* meltano_Result_Error_Get(long long int handle);
extern void meltano_Result_Error_Set(long long int handle, char* val);

// --- wrapping struct: meltano.MeltanoAdapter ---
//
extern long long int meltano_MeltanoAdapter_CTor();
extern char meltano_MeltanoAdapter_IsAvailable(long long int _handle);
extern char* meltano_MeltanoAdapter_InitProject(long long int _handle, char* name, char* directory);
extern char* meltano_MeltanoAdapter_GetProjectInfo(long long int _handle);
extern char* meltano_MeltanoAdapter_AddPlugin(long long int _handle, char* pluginType, char* name, char* variant);
extern char* meltano_MeltanoAdapter_InstallPlugins(long long int _handle);
extern char* meltano_MeltanoAdapter_RunPipeline(long long int _handle, char* extractor, char* loader, char* transformer);
extern char* meltano_MeltanoAdapter_ExecuteCommand(long long int _handle, char* command, long long int args);
extern char* meltano_MeltanoAdapter_GetPlugins(long long int _handle);
extern char* meltano_MeltanoAdapter_CreateAdapter(long long int _handle, char* adapterType, long long int config);
extern char* meltano_MeltanoAdapter_ListProjects(long long int _handle, char* rootDir);
extern char* meltano_MeltanoAdapter_GetProcessPoolStats(long long int _handle);
extern char* meltano_MeltanoAdapter_GetStateStats(long long int _handle);
extern char* meltano_MeltanoAdapter_SavePluginState(long long int _handle, char* project, char* plugin, long long int state);
extern char* meltano_MeltanoAdapter_LoadPluginState(long long int _handle, char* project, char* plugin);
extern char* meltano_MeltanoAdapter_DeletePluginState(long long int _handle, char* project, char* plugin);
extern char* meltano_MeltanoAdapter_GetVersion(long long int _handle);
extern char* meltano_MeltanoAdapter_Close(long long int _handle);
extern long long int meltano_NewMeltanoAdapter();
extern long long int meltano_NewMeltanoAdapterWithConfig(char* pythonPath, char* projectRoot);
extern long long int meltano_QuickInit();
extern long long int meltano_QuickInitWithConfig(char* pythonPath, char* projectRoot);
extern char meltano_QuickCheck();
