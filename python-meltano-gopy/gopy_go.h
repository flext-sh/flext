...
/* package github.com/flext-sh/flext/python-meltano-gopy */
...
//
extern long long int gopy_MeltanoAdapter_CTor();
extern char gopy_MeltanoAdapter_IsAvailable(long long int _handle);
extern char* gopy_MeltanoAdapter_InitProject(long long int _handle, char* name, char* directory);
extern char* gopy_MeltanoAdapter_GetProjectInfo(long long int _handle);
extern char* gopy_MeltanoAdapter_AddPlugin(long long int _handle, char* pluginType, char* name, char* variant);
extern char* gopy_MeltanoAdapter_InstallPlugins(long long int _handle);
extern char* gopy_MeltanoAdapter_RunPipeline(long long int _handle, char* extractor, char* loader, char* transformer);
extern char* gopy_MeltanoAdapter_ExecuteCommand(long long int _handle, char* command, long long int args);
extern char* gopy_MeltanoAdapter_GetPlugins(long long int _handle);
extern char* gopy_MeltanoAdapter_CreateAdapter(long long int _handle, char* adapterType, long long int config);
extern char* gopy_MeltanoAdapter_ListProjects(long long int _handle, char* rootDir);
extern char* gopy_MeltanoAdapter_GetProcessPoolStats(long long int _handle);
extern char* gopy_MeltanoAdapter_GetStateStats(long long int _handle);
extern char* gopy_MeltanoAdapter_SavePluginState(long long int _handle, char* project, char* plugin, long long int state);
extern char* gopy_MeltanoAdapter_LoadPluginState(long long int _handle, char* project, char* plugin);
extern char* gopy_MeltanoAdapter_DeletePluginState(long long int _handle, char* project, char* plugin);
extern char* gopy_MeltanoAdapter_GetVersion(long long int _handle);
extern char* gopy_MeltanoAdapter_Close(long long int _handle);

// --- wrapping struct: gopy.ProjectInfo ---
//
extern long long int gopy_ProjectInfo_CTor();
extern char* gopy_ProjectInfo_Name_Get(long long int handle);
extern void gopy_ProjectInfo_Name_Set(long long int handle, char* val);
extern char* gopy_ProjectInfo_Path_Get(long long int handle);
extern void gopy_ProjectInfo_Path_Set(long long int handle, char* val);
extern char* gopy_ProjectInfo_Environment_Get(long long int handle);
extern void gopy_ProjectInfo_Environment_Set(long long int handle, char* val);

// --- wrapping struct: gopy.Result ---
//
extern long long int gopy_Result_CTor();
extern char gopy_Result_Success_Get(long long int handle);
extern void gopy_Result_Success_Set(long long int handle, char val);
extern char* gopy_Result_Error_Get(long long int handle);
extern void gopy_Result_Error_Set(long long int handle, char* val);
extern long long int gopy_NewMeltanoAdapter();
extern long long int gopy_QuickInit();
extern long long int gopy_NewMeltanoAdapterWithConfig(char* pythonPath, char* projectRoot);
extern long long int gopy_QuickInitWithConfig(char* pythonPath, char* projectRoot);
extern char gopy_QuickCheck();
extern char* gopy_AddPluginToProject(char* pluginType, char* name, char* variant);
extern char* gopy_GetMeltanoVersion();
extern char* gopy_RunMeltanoPipeline(char* extractor, char* loader, char* transformer);
extern char gopy_CheckMeltanoAvailable();
extern char* gopy_CreateProject(char* directory, char* name);
extern char* gopy_ExecuteMeltanoCommand(char* command, long long int args);
extern char* gopy_GetProjectPlugins();
