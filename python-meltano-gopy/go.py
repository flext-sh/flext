# python wrapper for package go within overall package gopy
...
class Slice_bool(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_bool_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
    ...
    def __len__(self) -> int:
        return _gopy.Slice_bool_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_bool_len(self.handle)
                return Slice_bool(handle=_gopy.Slice_bool_subslice(self.handle, st, ed))
...
class Slice_byte(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_byte_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_byte_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_byte_len(self.handle)
                return Slice_byte(handle=_gopy.Slice_byte_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
                key += len(self)
    ...
    def __bytes__(self) -> bytes:
        ...
        return _gopy.Slice_byte_to_bytes(self.handle)
...
class Slice_error(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_error_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_error_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_error_len(self.handle)
                return Slice_error(
                    handle=_gopy.Slice_error_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_float32(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_float32_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_float32_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_float32_len(self.handle)
                return Slice_float32(
                    handle=_gopy.Slice_float32_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_float64(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_float64_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_float64_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_float64_len(self.handle)
                return Slice_float64(
                    handle=_gopy.Slice_float64_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_int(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_int_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_int_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_int_len(self.handle)
                return Slice_int(handle=_gopy.Slice_int_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_int16(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_int16_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_int16_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_int16_len(self.handle)
                return Slice_int16(
                    handle=_gopy.Slice_int16_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_int32(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_int32_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_int32_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_int32_len(self.handle)
                return Slice_int32(
                    handle=_gopy.Slice_int32_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_int64(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_int64_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_int64_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_int64_len(self.handle)
                return Slice_int64(
                    handle=_gopy.Slice_int64_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_int8(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_int8_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_int8_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_int8_len(self.handle)
                return Slice_int8(handle=_gopy.Slice_int8_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_rune(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_rune_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_rune_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_rune_len(self.handle)
                return Slice_rune(handle=_gopy.Slice_rune_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_string(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_string_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_string_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_string_len(self.handle)
                return Slice_string(
                    handle=_gopy.Slice_string_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_uint(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_uint_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_uint_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_uint_len(self.handle)
                return Slice_uint(handle=_gopy.Slice_uint_subslice(self.handle, st, ed))
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
                key += len(self)
...
class Slice_uint16(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_uint16_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_uint16_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_uint16_len(self.handle)
                return Slice_uint16(
                    handle=_gopy.Slice_uint16_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_uint32(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_uint32_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_uint32_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_uint32_len(self.handle)
                return Slice_uint32(
                    handle=_gopy.Slice_uint32_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_uint64(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_uint64_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_uint64_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_uint64_len(self.handle)
                return Slice_uint64(
                    handle=_gopy.Slice_uint64_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
...
class Slice_uint8(GoClass):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(kwargs) == 1 and "handle" in kwargs:
            ...
            self.handle = _gopy.Slice_uint8_CTor()
            _gopy.IncRef(self.handle)
            if len(args) > 0:
                if not isinstance(args[0], _collections_abc.Iterable):
    ...
    def __len__(self) -> int:
        return _gopy.Slice_uint8_len(self.handle)
        ...
        if isinstance(key, slice):
            if key.step is None or key.step == 1:
                ...
                if st is None:
                    st = 0
                if ed is None:
                    ed = _gopy.Slice_uint8_len(self.handle)
                return Slice_uint8(
                    handle=_gopy.Slice_uint8_subslice(self.handle, st, ed)
                )
            return [self[ii] for ii in range(*key.indices(len(self)))]
        if isinstance(key, int):
            if key < 0:
