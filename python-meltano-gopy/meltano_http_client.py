...
class MeltanoHTTPClient:
    ...
    def add_plugin(self, plugin_type: str, name: str, variant: str = "") -> dict[str, Any]:
    ...
    def save_state(self, project: str, plugin: str, state: dict[str, Any]) -> dict[str, Any]:
...
def AddPluginToProject(plugin_type: str, name: str, variant: str = "") -> dict[str, Any]:
    """Add plugin (compatibility function)"""
    return get_client_instance().add_plugin(plugin_type, name, variant)

def RunMeltanoPipeline(extractor: str, loader: str, transformer: str = "") -> dict[str, Any]:
