...
class MeltanoAdapter(go.GoClass):
    ...
    def AddPlugin(self, pluginType, name, variant):
        ...
        """
        return _gopy.gopy_MeltanoAdapter_AddPlugin(
    ...
    def RunPipeline(self, extractor, loader, transformer):
        ...
        """
        return _gopy.gopy_MeltanoAdapter_RunPipeline(
    ...
    def ExecuteCommand(self, command, args):
        ...
        """
        return _gopy.gopy_MeltanoAdapter_ExecuteCommand(
    ...
    def CreateAdapter(self, adapterType, config):
        ...
        """
        return _gopy.gopy_MeltanoAdapter_CreateAdapter(
    ...
    def SavePluginState(self, project, plugin, state):
        ...
        """
        return _gopy.gopy_MeltanoAdapter_SavePluginState(
...
def NewMeltanoAdapterWithConfig(pythonPath, projectRoot):
    ...
    return MeltanoAdapter(
        handle=_gopy.gopy_NewMeltanoAdapterWithConfig(pythonPath, projectRoot)
    )
...
def QuickInitWithConfig(pythonPath, projectRoot):
    ...
    """
    return MeltanoAdapter(
        handle=_gopy.gopy_QuickInitWithConfig(pythonPath, projectRoot)
    )
