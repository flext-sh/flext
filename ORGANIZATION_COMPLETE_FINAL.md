...
|---------|---------|-------|----------|---------|
| client-a-oud-mig | ✅ Active | ✅ 4 files | ✅ Standardized | ✅ 5 files |
| client-b-meltano-native | ✅ Active | ❌ No tests | ✅ Standardized | ✅ 4 files |
| client-b-poc-oic-wms | ✅ Active | ✅ 1 file | ✅ Standardized | ✅ 1 file |
...
./flx migration status client-a-oud         # client-a status: 85% groups complete
./flx migration status client-b          # client-b: 100% complete

# Run migrations
./flx migration run client-a-oud --dry-run  # Preview client-a migration
...
│   ├── client-a-oud-mig/               # ✅ 5 files cleaned, Makefile ✅
│   ├── client-b-meltano-native/     # ✅ 4 files cleaned, Makefile ✅
│   └── client-b-poc-oic-wms/        # ✅ 1 file cleaned, Makefile ✅
...
3. **Migration monitoring**: `./flx migration status client-a-oud`
