...
class ArchitectureDocumentationGenerator:
    ...
    def __init__(self, config_file: str | None = None) -> None:
        ...
        self.output_dir = Path(str(self.config.get("output_dir", "docs/architecture")))
    ...
    def merge_config(
        ...
        for key, value in override.items():
            if isinstance(value, dict) and key in base and isinstance(base[key], dict):
                # Recursive call with proper runtime type checking
...
"""
    ...
    def generate_comprehensive_report(self) -> None:
        ...
        # Note: report variable intentionally unused as it's just for generation
