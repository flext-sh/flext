...
def generate_consolidation_report(analysis):
...
if __name__ == "__main__":
    ...
    # Save analysis data
    with open("/home/marlonsc/pyauto/reports/analysis/test_consolidation_analysis.json", "w", encoding="utf-8") as f:
        json.dump(analysis, f, indent=2)

    # Save report
    with open("/home/marlonsc/pyauto/reports/analysis/test_consolidation_report.md", "w", encoding="utf-8") as f:
        f.write(report)

    print("✅ Analysis complete!")
    print("📄 Report saved: /home/marlonsc/pyauto/reports/analysis/test_consolidation_report.md")
    print("📊 Data saved: /home/marlonsc/pyauto/reports/analysis/test_consolidation_analysis.json")
