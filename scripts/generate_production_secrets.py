...
def create_production_secrets() -> dict:
    ...
    return {
        ...
        "db_REDACTED_LDAP_BIND_PASSWORD_password": generate_database_password(32),
        # Redis password
...
FLEXT_API_CORS_ORIGINS=["https://app.flext.com","https://REDACTED_LDAP_BIND_PASSWORD.flext.com"]
...
FLEXT_API_DATABASE_URL=postgresql://flext_prod:{secrets_data["db_password"]}@internal.invalid:5432/flext_production
FLEXT_API_DATABASE_POOL_SIZE=50

# Redis configuration (production redis with auth)
FLEXT_API_REDIS_URL=redis://:{secrets_data["redis_password"]}@internal.invalid:6379/0
...
DJANGO_DEBUG=false
DJANGO_ALLOWED_HOSTS=app.flext.com,REDACTED_LDAP_BIND_PASSWORD.flext.com
...
DATABASE_URL=postgresql://flext_web_prod:{secrets_data["db_password"]}@internal.invalid:5432/flext_web_production

# Cache (production redis with auth)
CACHE_URL=redis://:{secrets_data["redis_password"]}@internal.invalid:6379/1
SESSION_ENGINE=django.contrib.sessions.backends.cache
SESSION_CACHE_ALIAS=default

# Email (production SMTP)
EMAIL_BACKEND=django.core.mail.backends.smtp.EmailBackend
EMAIL_HOST=internal.invalid
EMAIL_PORT=587
EMAIL_USE_TLS=true
...
CORS_ALLOWED_ORIGINS=[
    "https://app.flext.com",
    "https://REDACTED_LDAP_BIND_PASSWORD.flext.com"
]
...
CSRF_TRUSTED_ORIGINS=["https://app.flext.com","https://REDACTED_LDAP_BIND_PASSWORD.flext.com"]
"""
