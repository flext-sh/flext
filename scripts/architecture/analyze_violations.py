...
class LayerType(Enum):
    ...
    APPLICATION = "application"  # algar-oud-mig, gruponos-meltano-native
...
class ArchitectureAnalyzer:
    ...
    def _classify_project_layer(self, project_name: str) -> LayerType:
        ...
        # Camada APPLICATION
        if project_name in {"algar-oud-mig", "gruponos-meltano-native"}:
    ...
    def _is_flext_import(self, import_name: str) -> bool:
        ...
        flext_patterns = [r"^flext[_-]", r"^algar[_-]", r"^gruponos[_-]"]
    ...
    def _check_module_placement(self, project: Project, file_path: Path) -> Violation | None:
        ...
        try:
            ...
            concrete_patterns = [r"meltano", r"oracle", r"ldap", r"singer", r"algar", r"gruponos"]
