...
run_step_allow_fail "Shell syntax" "bash -n scripts/validation/enforce_no_dict_no_any.sh && bash -n scripts/validation/enforce_pydantic_v2_skill.sh && bash -n scripts/validation/fix_pydantic_v2_violations.sh && bash -n scripts/validation/run_automated_validation.sh && bash -n scripts/validate_all_projects.sh && bash -n scripts/validation/check_skill_format.sh" "$REPORT_DIR/scripts-validation--log--shell-syntax.log"
run_step_allow_fail "Skill format" "scripts/validation/check_skill_format.sh --root '$ROOT_DIR'" "$REPORT_DIR/scripts-validation--log--skill-format.log"
