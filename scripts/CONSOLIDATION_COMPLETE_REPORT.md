...
- ❌ **23 scripts** só no `client-a-oud-mig/scripts/`
...
- **`client-a-oud-mig/scripts/legacy/`**: 20 scripts específicos do projeto
...
### **Do `client-a-oud-mig/scripts/` (20 scripts)**
