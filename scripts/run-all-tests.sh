...
mkdir -p test-results/{coverage,logs,reports}
...
go tool cover -html=test-results/coverage/combined.out -o test-results/coverage/combined.html
...
echo "📁 Results available at: /app/test-results/"
echo "📊 Coverage reports: /app/test-results/coverage/"
echo "📋 Full summary: /app/test-results/summary.md"

# Keep container running for result inspection
echo ""
echo "⏸️  Container will remain running for result inspection..."
tail -f /dev/null
