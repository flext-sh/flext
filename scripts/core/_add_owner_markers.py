...
SKILL_MAP: dict[str, str] = {
    ...
    "scripts/safe_edit.sh": "scripts-infra",
    "scripts/edit_with_hooks.sh": "scripts-infra",
    "scripts/edit_with_lock.sh": "scripts-infra",
    "scripts/auto_edit_with_hooks.sh": "scripts-infra",
    "scripts/pre_edit_validate.sh": "scripts-infra",
    "scripts/post_edit_validate.sh": "scripts-infra",
    "scripts/post_edit_validate_no_rollback.sh": "scripts-infra",
    "scripts/pre_command_validate.sh": "scripts-infra",
    "scripts/confirm_changes.sh": "scripts-infra",
    "scripts/confirm_fixes.sh": "scripts-infra",
    ...
    "scripts/cursor_agent_example.sh": "scripts-infra",
    "scripts/cursor_status.py": "scripts-infra",
    "scripts/install_cursor_automation.py": "scripts-infra",
    "scripts/update_cursor_rules.py": "scripts-infra",
    "scripts/update_vscode_git_exclusions.py": "scripts-infra",
    ...
    "scripts/validation/enforce_no_dict_no_any.sh": "scripts-validation",
    "scripts/validation/enforce_pydantic_v2_skill.sh": "scripts-validation",
    "scripts/validation/fix_pydantic_v2_violations.sh": "scripts-validation",
    "scripts/validation/run_skill_autofix.sh": "scripts-validation",
    "scripts/validation/run_skill_scan.sh": "scripts-validation",
    "scripts/validation/collect_file_metrics.py": "scripts-validation",
    "scripts/validation/domain_separation_validator.sh": "scripts-validation",
    "scripts/validation/ecosystem_quality_validator.sh": "scripts-validation",
    "scripts/validate_all_projects.sh": "scripts-validation",
    "scripts/quick_lint_check.sh": "scripts-validation",
    "scripts/baseline_quality_check.sh": "scripts-validation",
    "scripts/constants_standardization_validator.sh": "scripts-validation",
    "scripts/detect_violations_large_scale.sh": "scripts-validation",
    "scripts/analyze_project_pre_violations.sh": "scripts-validation",
    "scripts/ecosystem_validation.py": "scripts-validation",
    "scripts/verify_standardization.py": "scripts-validation",
    "scripts/fix_ruff_errors.py": "scripts-validation",
    "scripts/singer_protocol_validator.sh": "scripts-validation",
    "scripts/field_parameter_standardizer.sh": "scripts-validation",
    # ── scripts-security ──
