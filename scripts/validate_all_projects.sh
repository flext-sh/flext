...
python3 scripts/core/skill_validate.py --skill flext-strict-typing --mode "$POLICY_MODE"
echo "✅ Global policy gate: PASSED"
echo ""

echo "=== PYDANTIC V2 SKILL POLICY GATE ==="
python3 scripts/core/skill_validate.py --skill lib-pydantic-v2 --mode "$POLICY_MODE"
