...
python -c "from dc_api_x.ext.auth.ldap import LdapAuthProvider; auth_provider = LdapAuthProvider('cn=admin,dc=example,dc=com', 'password', 'ldap.example.com'); print('LDAP provider instance created successfully')"
