#!/usr/bin/env python3
"""Script para criar colunas de auditoria nas tabelas WMS."""
...
def create_audit_columns() -> None:
    """Cria colunas de auditoria nas tabelas WMS."""
    print("=== CRIAÇÃO DE COLUNAS DE AUDITORIA ===")
    ...
    try:
        ...
        for table_name in tables:
            try:
                ...
                audit_count = (
                    audit_result[0][0]
                    if audit_result and len(audit_result[0]) > 0
                    else 0
                )
                ...
                if existing_audit:
                    existing_names = [row[0] for row in existing_audit]
