...
class PoetryValidator:
    ...
    def validate_project(self, project_path: Path) -> dict[str, any]:
        """
        Valida um projeto Poetry completo.
    ...
    def _validate_poetry_structure(self, data: dict) -> tuple[bool, list[str]]:
    ...
    def _validate_project_metadata(self, data: dict) -> tuple[bool, list[str]]:
        """Valida metadados do projeto."""
    ...
    def _validate_dependencies(self, data: dict) -> tuple[bool, list[str]]:
    ...
    def _validate_lock_file(self, project_path: Path) -> tuple[bool, list[str]]:
        ...
        # Verifica se lock está atualizado
        try:
    ...
    def _collect_project_info(self, data: dict) -> dict:
        """Coleta informações do projeto."""
        poetry = data.get("tool", {}).get("poetry", {})
    ...
    def validate_workspace(self, workspace_path: Path) -> dict[str, dict]:
        """
