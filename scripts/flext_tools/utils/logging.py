...
class DetailedLogger:
    ...
    def debug(self, operation_type: str, message: str, details: dict | None = None):
        """Log de debug."""
        self.log(LogLevel.DEBUG, operation_type, message, details or {})

    def info(self, operation_type: str, message: str, details: dict | None = None):
        """Log de informação."""
        self.log(LogLevel.INFO, operation_type, message, details or {})

    def warning(self, operation_type: str, message: str, details: dict | None = None):
        """Log de warning."""
        self.log(LogLevel.WARNING, operation_type, message, details or {})

    def error(self, operation_type: str, message: str, details: dict | None = None):
        """Log de erro."""
        self.log(LogLevel.ERROR, operation_type, message, details or {})

    def critical(self, operation_type: str, message: str, details: dict | None = None):
        """Log crítico."""
        self.log(LogLevel.CRITICAL, operation_type, message, details or {})

    def _print_console_log(self, entry: LogEntry):
...
def set_global_logger(logger: DetailedLogger):
