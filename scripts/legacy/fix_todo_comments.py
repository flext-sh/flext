...
def convert_todo_to_issue_format(content: str) -> str:
    ...
    todo_conversions = {
        ...
        r"TODO.*SOLID refactoring.*Extract methods.*reduce complexity":
            "REFACTOR(@client-a-team): Extract methods to reduce complexity #complexity-reduction",

        r"TODO.*SOLID refactoring.*Extract.*complexity":
            "REFACTOR(@client-a-team): Apply SOLID principles for complexity reduction #solid-compliance",

        # Architecture improvements
        r"TODO.*refactor.*complexity":
            "REFACTOR(@client-a-team): Reduce method complexity #complexity-reduction",

        r"TODO.*extract.*method":
            "REFACTOR(@client-a-team): Extract method for better separation of concerns #method-extraction",

        # Performance improvements
        r"TODO.*performance":
            "OPTIMIZE(@client-a-team): Performance optimization needed #performance",

        # Type safety improvements
        r"TODO.*typing.*Any":
            "TYPING(@client-a-team): Replace Any with specific types #type-safety",

        # Error handling improvements
        r"TODO.*error.*handling":
            "ENHANCE(@client-a-team): Improve error handling #error-handling",
    }
