...
class ProjectAuditor:
    ...
    def _find_flext_projects(self) -> list[str]:
        ...
        client_projects = ["client-a-oud-mig", "client-b-poc-oic-wms"]
        projects.extend(
            project
    ...
    def _classify_project(self, project_name: str) -> str:
        ...
        if project_name in {"client-a-oud-mig", "client-b-poc-oic-wms"}:
    ...
    def _audit_documentation(self, project_path: Path) -> dict[str, Any]:
        ...
        docs = {
            ...
            "has_claude_local": (project_path / "internal.invalid.md").exists(),
        ...
        for doc_file in ["CLAUDE.md", "internal.invalid.md", "README.md"]:
