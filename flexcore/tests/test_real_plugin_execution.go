...
func main() {
	fmt.Println("🔥 TESTE REAL - Execução de Plugin REAL")
	...
	// Test 3: Carregar plugin REAL compilado
	fmt.Println("\n3. 📦 Carregando plugin REAL compilado...")
	
	pluginPath := "../plugins/data-processor/data-processor"
	loadResult := pluginManager.LoadPlugin(ctx, "data-processor", pluginPath)
	...
	// Test 6: Executar plugin com dados REAIS
	fmt.Println("\n6. ⚡ Executando plugin com dados REAIS...")
		...
		"data": []map[string]interface{}{
			{
				"id":        1,
				"name":      "Teste Real",
				"timestamp": "2025-07-01T21:52:00Z",
				"value":     42.5,
			},
			{
				"id":        2,
				"name":      "Outro Teste",
				"timestamp": "2025-07-01T21:52:01Z",
				"value":     37.8,
			},
		},
	...
	fmt.Println("\n🎉 TESTE DE EXECUÇÃO DE PLUGIN COMPLETO!")
	fmt.Println("✅ Plugin REAL carregado e executado com sucesso")
	fmt.Println("✅ Processamento de dados funcionando")
	fmt.Println("✅ Sistema HashiCorp go-plugin validado")
}