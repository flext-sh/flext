...
- **Manual wrapper nesting for private mixins** — forbidden. Compose `_models/*` and `_utilities/*` mixins in the facade MRO instead of writing `class Docker(FlextTestsDocker): ...`.
