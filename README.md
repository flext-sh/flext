...
- **client-a-oud-mig**: Migração client-a Oracle Unified Directory
- **client-b-meltano-native**: Implementação nativa Meltano para client-b
- **client-b-poc-oic-wms**: PoC integração OIC-WMS
