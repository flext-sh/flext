...
- Root engineering law lives in `AGENTS.md`
- Architecture baseline lives in `docs/architecture/baseline-v0.13.0.md`
- Migration sequencing lives in `docs/guides/migration-to-v0.13.0.md`
