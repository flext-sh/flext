...
├─────────────────────────────────────────────────────────────────┤
│ Client Projects (2): client-a-oud-mig | client-b-meltano-native    │
├─────────────────────────────────────────────────────────────────┤
...
- **Used By**: End users, REDACTED_LDAP_BIND_PASSWORDistrators
- **Documentation**:
...
- **Used By**: Developers, DevOps, REDACTED_LDAP_BIND_PASSWORDistrators
- **Documentation**:
...
- **Dependencies**: flext-core
- **Used By**: Oracle taps/targets, WMS integration, client-a migration
- **Documentation**:
...
- **Dependencies**: flext-core
- **Used By**: flext-auth, LDAP tap/target, client-a migration
- **Documentation**:
...
### **32. client-a-oud-mig** - client-a Oracle Unified Directory Migration

- **Path**: [`client-a-oud-mig/`](../client-a-oud-mig/)
- **Type**: Specialized Service (Python 3.13)
- **Purpose**: client-a Oracle Unified Directory migration project
...
- **Documentation**: [README](../client-a-oud-mig/README.md) | [CLAUDE.md](../client-a-oud-mig/CLAUDE.md)

### **33. client-b-meltano-native** - client-b Meltano Implementation

- **Path**: [`client-b-meltano-native/`](../client-b-meltano-native/)
- **Type**: Specialized Service (Python 3.13)
- **Purpose**: client-b-specific Meltano implementation with FLEXT patterns
...
- **Documentation**: [README](../client-b-meltano-native/README.md) | [CLAUDE.md](../client-b-meltano-native/CLAUDE.md)
