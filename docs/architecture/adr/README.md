...
- [ADR-0016: Public make work lane saga](016-make-work-lane-saga.md) — _Accepted (Gas Town-native workflow is the authoritative surface; `make work` is retained as backward-compatible internal surface)_
