...
**Depends:** builds on ADR-005 (config/settings SSOT) and the repository FLEXT law — §1.2 Pydantic-2 models everywhere, §3.2 types come from protocols `p.*` not concrete models, §3a JSON is Pydantic 2-way, §1.5 no duplicated declarations across projects.
