...
flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:1:89: W505 Doc line too long (100 > 88)
|
1 | """Integration Compatibility Tests for algar-oud-mig Project - PyAuto Workspace Standards Compliant.
| ^^^^^^^^^^^^ W505
2 |
3 | This module provides comprehensive validation of ldap-core-shared compatibility
|

flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:57:51: F401 `ldap_core_shared.connections.info.ConnectionInfo` imported but unused; consider using `importlib.util.find_spec` to test for availability
|
55 | # Import components expected by algar-oud-mig
56 | try:
57 | from ldap_core_shared.connections.info import ConnectionInfo
| ^^^^^^^^^^^^^^ F401
58 |
59 | # Import exceptions expected by algar-oud-mig
|
= help: Remove unused import: `ldap_core_shared.connections.info.ConnectionInfo`

flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:87:9: F401 `ldap_core_shared.ldif.writer.LDIFHeaderConfig` imported but unused; consider using `importlib.util.find_spec` to test for availability
|
85 | )
...
flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:89:9: F401 `ldap_core_shared.ldif.writer.LDIFWriterConfig` imported but unused; consider using `importlib.util.find_spec` to test for availability
|
87 | LDIFHeaderConfig,
88 | LDIFWriter,
89 | LDIFWriterConfig,
...
flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:93:51: F401 `ldap_core_shared.utilities.filter.FilterBuilder` imported but unused; consider using `importlib.util.find_spec` to test for availability
|
91 | from ldap_core_shared.schema.discovery import SchemaDiscovery, SchemaDiscoveryConfig
...
flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:93:66: F401 `ldap_core_shared.utilities.filter.LDAPFilter` imported but unused; consider using `importlib.util.find_spec` to test for availability
|
91 | from ldap_core_shared.schema.discovery import SchemaDiscovery, SchemaDiscoveryConfig
92 | from ldap_core_shared.utilities.dn import DistinguishedName, normalize_dn
93 | from ldap_core_shared.utilities.filter import FilterBuilder, LDAPFilter
...
flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:148:89: W505 Doc line too long (96 > 88)
|
146 | self, validate_workspace_venv
147 | ) -> None:
148 | """Test algar-oud-mig integration workspace venv validation as required by CLAUDE.md."""
| ^^^^^^^^ W505
149 | # Fixture automatically validates workspace venv usage
150 | expected_venv = "/home/marlonsc/pyauto/.venv"
|

flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:160:89: W505 Doc line too long (96 > 88)
|
158 | self, validate_env_security
159 | ) -> None:
160 | """Test algar-oud-mig integration .env security enforcement as required by CLAUDE.md."""
| ^^^^^^^^ W505
161 | # Test ALGAR-specific configuration security
162 | algar_env_vars = {
|

flext-ldap/tests/test_algar_oud_mig_integration_compatibility.py:441:89: W505 Doc line too long (92 > 88)
|
439 | @pytest.mark.performance
440 | def test_performance_monitor_algar_metrics_structure(self) -> None:
441 | """Test performance monitor metrics structure matches algar-oud-mig expectations."""
| ^^^^ W505
442 | monitor = PerformanceMonitor("algar_professional_transformation")
|
...
|
67 | server,
68 | user="cn=admin,dc=test,dc=com",
...
|
98 | server,
99 | user="cn=admin,dc=test,dc=com",
...
|
20 | port=389,
21 | bind_dn="cn=admin,dc=test,dc=com",
...
32 | assert client.bind_dn == "cn=admin,dc=test,dc=com"
...
|
75 | mock_server,
76 | user="cn=admin,dc=test,dc=com",
...
|
103 | server,
104 | user="cn=admin,dc=source,dc=com",
...
|
121 | server,
122 | user="cn=admin,dc=target,dc=com",
...
33 | assert client.bind_dn == "cn=admin,dc=test,dc=com"
