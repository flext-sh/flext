...
### 📂 client-a-oud-mig/scripts/ (23 scripts)
...
- [ ] Verificar se scripts em client-a-oud-mig são específicos do projeto
...
**ALTA**: client-a-oud-mig tem 23 scripts que podem estar duplicando funcionalidade
