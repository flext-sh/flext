...
**PROBLEMA**: algar-oud-mig e gruponos-poc-oic-wms misturados com framework
**AÇÃO**: Mover para pasta separada

```bash
# IMPLEMENTAR AGORA
mkdir client-projects/
mv algar-oud-mig client-projects/
mv gruponos-poc-oic-wms client-projects/
```
...
2. **Projetos Cliente Ativos**: algar-oud-mig e gruponos-poc em produção
