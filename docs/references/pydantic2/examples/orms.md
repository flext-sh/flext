...
Pydantic serves as a great tool for defining models for ORM (t.RecursiveContainer relational mapping) libraries.
...
class MyModel(BaseModel):
    ...
    metadata: t.StrMapping = u.Field(alias="metadata_")
