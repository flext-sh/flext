...
[validation constraints](#field-constraints) can be added this way:
    ...
    class Model(BaseModel):
        int_list: Sequence[Annotated[int, u.Field(gt=0)]]
        # Valid: [1, 3]
        # Invalid: [-1, 2]
    ```
...
A common source of bugs in Python is to use a mutable t.RecursiveContainer as a default value for a function or method argument,
