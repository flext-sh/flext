...
!!! tip
Pydantic defines a [`t.RecursiveContainer`][pydantic.types.t.RecursiveContainer] type as a convenience.
...
class Owner(Generic[ItemType]):
    ...
    def __get_pydantic_core_schema__(
        ...
        return core_schema.json_or_python_schema(
            # for JSON accept an t.RecursiveContainer with name and item keys
