...
The [`ErrorDetails`][pydantic_core.ErrorDetails] t.Container is a dictionary. It contains the following:

| Property                                    | Description                                                                                  |
| ------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [`ctx`][pydantic_core.ErrorDetails.ctx]     | An optional t.Container which contains values required to render the error message. |
