...
### **🏛️ client-a-oud-mig** - client-a Migration

**Path**: [`client-a-oud-mig/`](../client-a-oud-mig/)  
**Purpose**: client-a Oracle Unified Directory migration

#### **Navigation Links**

- **[README.md](../client-a-oud-mig/README.md)** - Migration project overview
- **[CLAUDE.md](../client-a-oud-mig/CLAUDE.md)** - Migration patterns
- **[Migration Guide](../client-a-oud-mig/docs/migration.md)** - Step-by-step guide
- **[Validation](../client-a-oud-mig/docs/validation.md)** - Data validation

### **🏢 client-b-meltano-native** - client-b Implementation

**Path**: [`client-b-meltano-native/`](../client-b-meltano-native/)  
**Purpose**: client-b-specific Meltano implementation

#### **Navigation Links**

- **[README.md](../client-b-meltano-native/README.md)** - client-b overview
- **[CLAUDE.md](../client-b-meltano-native/CLAUDE.md)** - Implementation patterns
- **[Custom Logic](../client-b-meltano-native/docs/custom-logic.md)** - Business rules
- **[Deployment](../client-b-meltano-native/docs/deployment.md)** - client-b deployment
