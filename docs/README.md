...
```bash
reference/
├── phpldapREDACTED_LDAP_BIND_PASSWORD-web-interface/      # ⭐ Interface web PHP clássica
...
### **🏢 Cenário 3: "Preciso REDACTED_LDAP_BIND_PASSWORDistrar um servidor LDAP"**
...
cd reference/phpldapREDACTED_LDAP_BIND_PASSWORD-web-interface/
...
4. **Web**: [`reference/phpldapREDACTED_LDAP_BIND_PASSWORD-web-interface/`](reference/phpldapREDACTED_LDAP_BIND_PASSWORD-web-interface/)
...
3. **Web**: [`reference/phpldapREDACTED_LDAP_BIND_PASSWORD-web-interface/`](reference/phpldapREDACTED_LDAP_BIND_PASSWORD-web-interface/)
