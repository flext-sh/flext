...
**Regras (CLAUDE.md + decisão do repositório):**
...
- **flext-core**
  - **FlextSettings.__init__**: Mantido `cast("dict[str, Any]", kwargs)` para `BaseSettings.__init__` com comentário de exceção de política (CLAUDE.md): fronteira de biblioteca; pydantic_settings espera kwargs dinâmicos.
- **flext-dbt-ldap**
