...
- **Solution**: Use `.internal.invalid` files that are not automatically loaded
...
├── .internal.invalid           # Local development (not auto-loaded)
...
# Copy to .internal.invalid and fill with actual values
...
class ConfigurationFactory:
    ...
    def create_config(environment: str = "development") -> EnvironmentConfig:
        ...
        env_files = {
            "development": [".internal.invalid", ".env.development", ".env"],
