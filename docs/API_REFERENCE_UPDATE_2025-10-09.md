...
- [FLEXT API Reference Update](#flext-api-reference-update)
  - [📊 API Overview](#-api-overview)
    - [Core Framework APIs](#core-framework-apis)
      - [flext-core](#flext-core)
- [Railway-oriented programming](#railway-oriented-programming)
- [Dependency injection](#dependency-injection) - [flext-api](#flext-api)
- [API models](#api-models)
- [API implementation](#api-implementation) - [flext-auth](#flext-auth)
...
- [LDIF models](#ldif-models)
- [LDIF processing](#ldif-processing) - [flext-ldap](#flext-ldap)
- [LDAP models](#ldap-models)
- [LDAP operations](#ldap-operations) - [flext-oracle](#flext-oracle)
- [Oracle models](#oracle-models)
- [Oracle operations](#oracle-operations)
  - [Singer Platform APIs](#singer-platform-apis)
    - [Taps (Data Extraction)](#taps-data-extraction)
- [LDAP Tap](#ldap-tap)
- [Oracle Tap](#oracle-tap)
- [Extract data](#extract-data) - [Targets (Data Loading)](#targets-data-loading)
- [LDAP Target](#ldap-target)
...
- [Returns: FlextResult[DatabaseConfig]](#returns-flextresultdatabaseconfig)
- [LDAP configuration](#ldap-configuration)
- [Returns: FlextResult[LdapConfig]](#returns-flextresultldapconfig)
- [API configuration](#api-configuration)
- [Returns: FlextResult[ApiConfig]](#returns-flextresultapiconfig)
...
- [✅ CORRECT - Root module imports](#-correct---root-module-imports) - [2. Type Safety Issues](#2-type-safety-issues)
- [❌ WRONG - Missing type annotations](#-wrong---missing-type-annotations)
- [✅ CORRECT - Complete type annotations](#-correct---complete-type-annotations) - [3. Error Handling](#3-error-handling)
- [❌ WRONG - Exception-based](#-wrong---exception-based)
- [✅ CORRECT - Railway-oriented](#-correct---railway-oriented)
  - [Debugging Tips](#debugging-tips)
- [Enable debug logging](#enable-debug-logging)
- [Use FlextLogger for structured logging](#use-flextlogger-for-structured-logging)
- [Check FlextResult details](#check-flextresult-details)
