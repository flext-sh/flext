...
> **Function**: Oracle Internet Directory to Oracle Unified Directory migration process | **Audience**: Migration teams, LDAP administrators | **Status**: Production-ready
...
LDAP_BIND_DN=cn=Directory Manager  # DN de administração OUD
LDAP_PASSWORD=sua_senha    # Senha do administrador
...
```bash
# Usando ldapsearch
ldapsearch -h OID_HOST -p OID_PORT -D "cn=orcladmin" -w SENHA -b "dc=exemplo,dc=com" -s sub "(objectclass=*)" > oid_export.ldif
