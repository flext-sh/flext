...
> **Function**: Complete OID to OUD migration implementation and enterprise transformation | **Audience**: Migration teams, directory administrators | **Status**: Production-ready
...
SOURCE_LDAP_BIND_DN="cn=orcladmin"
