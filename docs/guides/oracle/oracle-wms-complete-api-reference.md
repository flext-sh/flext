...
```
FLX Hexagonal Architecture - Actual Implementation
...
└── Adapters (Infrastructure)
    ├── WmsClient (flx_http_oracle_wms.wms_client)
    ├── WmsConfig (flx_http_oracle_wms.config)
...
### **Prerequisites**
- [Getting Started Hub](../../getting-started/index.md) - Essential FLX Framework installation and setup before Oracle integration
...
### **Related Topics**
- [API Reference Hub](../../api-reference/index.md) - Complete FLX Framework API documentation for adapter development
