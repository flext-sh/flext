...
WMS Column: DocumentVersion, WMS Format: string, Required?: , Value: "23.1.0", Notes: Informational only.
...
WMS Column: ClientEnvCode, WMS Format: string, Required?: , Value: "23A", Notes: Informational only.
