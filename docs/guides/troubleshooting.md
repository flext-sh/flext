...
- [FLEXT Troubleshooting Guide](#flext-troubleshooting-guide)
  - [Quick Diagnosis](#quick-diagnosis)
    - [Health Check Commands](#health-check-commands)
- [Check overall system health](#check-overall-system-health)
- [Check specific components](#check-specific-components)
- [Check individual projects](#check-individual-projects)
...
- [Error](#error) - [Solutions](#solutions) - [Root Cause Analysis](#root-cause-analysis)
...
- [Error](#error) - [Solutions](#solutions)
- [❌ WRONG](#-wrong)
- [✅ CORRECT](#-correct)
...
- [Error](#error) - [Solutions](#solutions)
- [Print all FLEXT environment variables](#print-all-flext-environment-variables)
- [Load and print configuration](#load-and-print-configuration)
  - [5. LDIF Processing Issues](#5-ldif-processing-issues)
    - [Problem: LDIF parsing fails](#problem-ldif-parsing-fails)
- [Error](#error) - [Solutions](#solutions)
- [Your LDIF processing code](#your-ldif-processing-code)
- [Check for common LDIF issues](#check-for-common-ldif-issues)
  - [6. Migration Issues](#6-migration-issues)
    - [Problem: Migration fails](#problem-migration-fails)
- [Error](#error) - [Solutions](#solutions)
- [Test migration with small sample](#test-migration-with-small-sample)
  - [7. Performance Issues](#7-performance-issues)
    - [Problem: Slow processing](#problem-slow-processing)
- [Symptoms](#symptoms)
- [- High memory usage](#--high-memory-usage)
- [- Slow response times](#--slow-response-times)
- [- Timeout errors](#--timeout-errors) - [Solutions](#solutions)
- [Reduce batch size for memory-constrained environments](#reduce-batch-size-for-memory-constrained-environments)
  - [Debugging Techniques](#debugging-techniques)
    - [1. Logging Configuration](#1-logging-configuration)
- [Configure logging](#configure-logging)
- [Use FLEXT logger](#use-flext-logger)
  - [2. Exception Handling](#2-exception-handling)
  - [3. Debug Mode](#3-debug-mode)
- [Enable debug mode](#enable-debug-mode)
- [Debug information will be printed](#debug-information-will-be-printed)
