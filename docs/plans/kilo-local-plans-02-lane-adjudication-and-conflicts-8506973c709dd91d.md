...
2. **LOC 200 vs gate 1000:** 1000 é o limite operacional existente; 200 é a lei de forma
   para módulos tocados. Não enfraquecer a lei nem mudar config apenas para esconder
   dívida.
...
- PR/worktree só é encerrado após contribuição integrada ou comprovadamente superseded e
  registrada no Gas City Bead.
