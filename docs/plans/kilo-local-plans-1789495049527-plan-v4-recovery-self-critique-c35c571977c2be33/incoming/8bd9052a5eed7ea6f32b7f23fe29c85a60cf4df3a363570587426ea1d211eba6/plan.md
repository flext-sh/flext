...
- **F2** engine: W1 facades split (FEITO via adoção), W2 primitivas
  ...
  REPORTA; nunca silenciar), W5 rules-as-data (`config/codegen.yaml`+`rules/_.yaml`), W6
  gate cosmos-docgen ×2 ANTES da frota, W7 agents_governance. Taxonomia: GEN-W001 sem
  `**all**`, W002 self-import absoluto (fix relativiza; overlay flext-core exceção
  declarada; lazy isento), W003 fora do layout, W004 formato/header, W005 ciclo SCC,
