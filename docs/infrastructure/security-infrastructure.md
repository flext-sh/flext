...
# Define roles
REDACTED_LDAP_BIND_PASSWORD_role = Role(name="REDACTED_LDAP_BIND_PASSWORD", permissions=permissions)
...
auth_service.add_role(REDACTED_LDAP_BIND_PASSWORD_role)
...
async def test_authentication(auth_service):
    ...
    assert "REDACTED_LDAP_BIND_PASSWORD" in claims["roles"]
```
...
async def test_sql_injection_protection():
    ...
    malicious_input = "REDACTED_LDAP_BIND_PASSWORD' OR '1'='1"
