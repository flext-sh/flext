...
# client-a-oud-mig/tests/test_migration_functionality.py
...
client-a-oud-mig/tests: ====== 11 passed in 0.18s ======
```
...
├── client-a-oud-mig/     ✅ client-a Oracle Migration
└── client-b-poc-oic-wms/ ✅ client-b POC
```
...
### ✅ Migration System (client-a-oud-mig)
