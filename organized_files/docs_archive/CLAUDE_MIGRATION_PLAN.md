...
### DE: /home/marlonsc/internal.invalid.md (CROSS-WORKSPACE)
...
- ✂️ Detalhes específicos do PyAuto → `/home/marlonsc/pyauto/internal.invalid.md`
...
- ✂️ Issues temporários → `/home/marlonsc/pyauto/internal.invalid.md`
- ✂️ Status de projetos → `/home/marlonsc/pyauto/internal.invalid.md`
...
### DE: /home/marlonsc/pyauto/internal.invalid.md (WORKSPACE TEMP)
...
CROSS-WORKSPACE (internal.invalid.md)
...
WORKSPACE TEMP (pyauto/internal.invalid.md)
├── Issues temporários
├── Status de projetos
└── Workarounds ativos
```
...
**Referência**: `./internal.invalid.md` → Issues temporários
```
...
3. **Refatorar** /home/marlonsc/internal.invalid.md (cross)
4. **Refatorar** /home/marlonsc/pyauto/CLAUDE.md (workspace)
5. **Refatorar** /home/marlonsc/pyauto/internal.invalid.md (temp)
