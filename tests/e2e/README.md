...
- **phpLDAPadmin**: Web UI for debugging (port 18080)
...
- Admin DN: `cn=admin,dc=source,dc=example,dc=com`
- Password: `admin_source_password`
...
- Admin DN: `cn=admin,dc=target,dc=example,dc=com`
- Password: `admin_target_password`
...
Access phpLDAPadmin: http://localhost:18080
