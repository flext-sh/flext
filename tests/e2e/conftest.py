    ...
    while time.time() - start_time < timeout:
        try:
            ...
            conn = Connection(
                ...
                user="cn=admin,dc=source,dc=example,dc=com",
            ...
            conn = Connection(
                ...
                user="cn=admin,dc=target,dc=example,dc=com",
