...
class TestFlextProcessingHandlerRegistry:
    ...
    def test_execute_handler_returning_flext_result(self) -> None:
        ...
        def result_handler(req: object) -> FlextResult[str]:
            # Note: req parameter unused in this test implementation
            _ = req  # Acknowledge unused parameter
    ...
    def test_execute_handler_with_exception(self) -> None:
        ...
        def failing_handler(req: object) -> Never:
            # Note: req parameter unused in this test implementation
            _ = req  # Acknowledge unused parameter
            msg = "Handler failed"
...
class TestFlextProcessingPipeline:
    ...
    def test_pipeline_with_failing_step(self) -> None:
        ...
        def failing_step(data: object) -> FlextResult[str]:
            # Note: data parameter unused in this test implementation
