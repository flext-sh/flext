...
class TestFlextLdapClientComprehensive:
    ...
    def test_client_factory_integration(self, flext_factories: FlextTestsFactories) -> None:
    ...
    def test_client_error_handling_consistency(self) -> None:
        ...
        for method_name, args in methods_to_test:
            ...
            assert result.is_failure, f"Method {method_name} should fail without connection"
    ...
    def test_client_with_flext_tests_integration(self, flext_factories: FlextTestsFactories) -> None:
