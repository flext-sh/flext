...
def ldap_container():
    ...
    for i in range(max_retries):
        try:
            ...
            conn = Connection(server, "cn=REDACTED_LDAP_BIND_PASSWORD,dc=flext-test,dc=local", "REDACTED_LDAP_BIND_PASSWORD123", auto_bind=True)
            conn.unbind()
            break
    ...
    def test_ldap_test_data_loaded(self, ldap_container: dict[str, Any]) -> None:
        ...
        for entry in conn.entries:
            if "john.doe" in str(entry.uid):
                ...
                assert "john.doe@internal.invalid" in str(entry.mail)
                break
...
class TestFlextLDAPIntegration:
    ...
    async def test_ldap_user_operations(self, ldap_container: dict[str, Any]) -> None:
        ...
        try:
            ...
            assert "john.doe@internal.invalid" in user.mail
    ...
    def test_ldap_group_operations(self, ldap_service: LDAPService) -> None:
        ...
        try:
            ...
            expected_cns = {"developers", "REDACTED_LDAP_BIND_PASSWORDs", "qa-team"}
...
class TestFlextTargetLDAPIntegration:
    ...
    def test_target_ldap_user_creation(self, target_config: dict[str, Any]) -> None:
        ...
        user_record = {
            ...
            "sn": "User",
            "givenName": "Test",
            "mail": "test.user@internal.invalid",
...
class TestFlextLDIFIntegration:
    ...
    #             "cn": "LDIF Test User",
    #             "sn": "User",
    #             "mail": "ldif.test@internal.invalid"
    #         }
    #     )
    #
