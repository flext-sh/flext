...
├── gruponos-poc-*/         # Business implementations
├── algar-oud-mig/          # Oracle directory migration (ex-oud-automation)
...
### **3. Business Implementations** (`gruponos-poc-*/`)
...
### **4. System Administration** (`algar-oud-mig/`)
...
gruponos-poc-oic-wms/ (implementation)
...
[Implementation Project](../gruponos-poc-oic-wms/README.md)
```
...
📋 **Dependencies**: [FLX Core](../flx/README.md) → This Plugin → [Implementation Projects](../gruponos-poc-oic-wms/README.md)
```
...
### **Phase 3: Implementations (`gruponos-poc-*/`, `algar-oud-mig/`)**
