...
- algar-oud-mig: 10 imports não utilizados (CORRIGIDOS automaticamente)
...
- `algar_oud_mig/_execute_async`: Complexidade 11 (limite 10)
- `algar_oud_mig/_process_schema_file`: Complexidade 21 (limite 10) 🚨
- `algar_oud_mig/_sync_schema_file`: Complexidade 19 (limite 10) 🚨
...
- [ ] **algar-oud-mig** - A auditar
- [ ] **gruponos-meltano-native** - A auditar
