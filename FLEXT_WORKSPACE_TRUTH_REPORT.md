...
|---------|---------|-------|----------|---------|
| client-a-oud-mig | LDAP migration | ✅ 420 passing | 77% | **PRODUCTION READY** |
| client-b-meltano-native | WMS→Analytics | ❌ Test issues | Unknown | **OPERATIONAL** (tests broken) |
...
2. **Fix client-b tests** - Remove duplicate test files
