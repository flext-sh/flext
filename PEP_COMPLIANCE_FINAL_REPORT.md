...
1. **flext-quality/analyzer/admin.py** - Decorator syntax error
2. **gruponos-meltano-native** - 3 arquivos com IndentationError
...
- **gruponos-meltano-native**: 36 arquivos formatados
...
- gruponos-meltano-native: 2 ocorrências
