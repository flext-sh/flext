...
func (d *SQLiteDriver) Open(dsn string) (driver.Conn, error) {
	...
	// auth_user_add can be used (by an REDACTED_LDAP_BIND_PASSWORD user only)
	...
	// auth_user_delete can be used (by an REDACTED_LDAP_BIND_PASSWORD user only)
