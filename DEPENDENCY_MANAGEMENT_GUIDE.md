...
├── client-b-poc-oic-wms/       # Implementation project
└── client-a-mig-oud/             # LDAP migration tool
```
...
from client-a_oud_mig.ldap import LdapConnection
```
...
- **Fire**: CLI framework for client-b-poc-oic-wms
- **python-ldap**: LDAP operations for client-a-mig-oud
