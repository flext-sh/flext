...
and integration with algar-oud-mig.
"""
...
class TestAlgarIntegration:
    """Integration tests for algar-oud-mig compatibility."""

    def test_migration_workflow_compatibility(self, tmp_path: Path) -> None:
        """Test that flx-ldap can support algar-oud-mig migration workflows."""
        # This test validates the migration pattern used by algar-oud-mig

        # Create migration config matching algar-oud-mig requirements
        ...
        target_config = TargetConfig(
            ...
            bind_dn="cn=admin,dc=new,dc=company,dc=com",
        ...
        # Verify configuration supports algar-oud-mig patterns
        assert (
    ...
    def test_custom_stream_support(self) -> None:
        """Test that custom streams can handle algar-oud-mig specific objects."""
        # algar-oud-mig needs to migrate custom object classes
        custom_streams = [
            {
        ...
        # Verify stream definitions match algar-oud-mig requirements
        assert (
    ...
    def test_dn_transformation_support(self) -> None:
        ...
        # Test various DN template patterns used by algar-oud-mig
        templates = [
