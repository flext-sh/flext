...
The constants module provides centralized LDAP constants used across the entire flx-ldap library. This ensures consistency, prevents magic numbers, and provides enterprise-grade configuration management.
