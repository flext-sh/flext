...
class MigrationPlanner:
    ...
    def detect_component_capabilities(self) -> dict[str, ComponentCapability]:
        ...
        # Check tap-ldap - conditional import
        try:
            import tap_ldap  # type: ignore[import-not-found]
        ...
        # Check target-ldap - conditional import
        try:
            import target_ldap  # type: ignore[import-not-found]
        ...
        # Check dbt-ldap (Meltano EDK component) - conditional import
        try:
            import dbt  # type: ignore[import-not-found]
    ...
    def create_migration_plan(
        ...
        pattern_config = self.MIGRATION_PATTERNS.get(
            migration_pattern,
            self.MIGRATION_PATTERNS["simple_sync"],
        )
