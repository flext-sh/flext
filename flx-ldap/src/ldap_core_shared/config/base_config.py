...
LEGACY COMPATIBILITY:
    ...
    config = LDAPServerConfig(host="server.com", bind_dn="cn=admin", ...)
...
class LDAPServerConfig:
    ...
    def __init__(self, host: str, port: int = LDAP_DEFAULT_PORT, bind_dn: str = "",
                 ...
                 pool_size: int = 10, **kwargs: object) -> None:
...
class LoggingConfig:
    ...
    def __init__(self, level: str = "INFO", format: str | None = None, file_path: Path | None = None,
                 ...
                 enable_console: bool = True, mask_sensitive_data: bool = True, **kwargs: object) -> None:
...
class SecurityConfig:
    ...
    def __init__(self, verify_ssl: bool = True, ca_cert_file: Path | None = None,
                 ...
                 encryption_key: str | None = None, mask_sensitive_data: bool = True, **kwargs: object) -> None:
