"""LDAP Connection Base Components - Professional extraction from client-a-oud-mig."""
...
class LDAPConnectionInfo(BaseModel):
    """Professional LDAP connection configuration extracted from client-a-oud-mig.
...
class LDAPSearchConfig(BaseModel):
    """Professional LDAP search configuration extracted from client-a-oud-mig.
...
class LDAPConnectionOptions(BaseModel):
    ...
    Extracted and enhanced from client-a-oud-mig LDAPConnectionOptions.
    """
