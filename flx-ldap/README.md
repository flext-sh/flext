...
export LDAP_TAP_BIND_DN=cn=REDACTED_LDAP_BIND_PASSWORD,dc=source,dc=com
...
## Integration with client-a-oud-mig

The CLI integrates with client-a-oud-mig for complex migration scenarios:

1. **Schema Migration**: Extracts and applies custom schema elements
2. **Data Transformation**: Uses client-a-oud-mig's transformation logic
