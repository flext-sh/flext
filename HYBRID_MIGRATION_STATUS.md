...
- **client-a-oud-mig** e **client-b-poc-oic-wms** mantidos na organização original
...
**Solicitação**: "remova flext-client-a-oud-mig e flext-client-b-poc-oic-wms do github de flex-sh e use o do datacosmos-br mesmo original"
...
├── datacosmos-br/
│   ├── client-a-oud-mig/           ← Enterprise (original)
│   └── client-b-poc-oic-wms/    ← Enterprise (original)
├── flext-sh/
