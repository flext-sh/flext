...
| **algar-mig-oud** | `algar-mig-oud/` | ✅ Production | 9 | 12 | `^3.13,<3.15` |
| **gruponos-poc-oic-wms** | `gruponos-poc-oic-wms/` | ✅ Production | 7 | 9 | `^3.13,<3.15` |
...
└── gruponos-poc-oic-wms → depends on ALL adapters + flx
    ├── flx-database-oracle
    ├── flx-http-oracle-oic
    ├── flx-http-oracle-wms
    └── flx
...
2. **Regenerate Lock Files**
   ...
   for project in flx flx-database-oracle flx-http-oracle-oic flx-http-oracle-wms algar-mig-oud gruponos-poc-oic-wms flx-adapter-example; do
