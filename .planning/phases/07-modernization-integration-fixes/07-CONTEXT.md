...
- **D-04:** Fix at call sites first (pass enum instances). If too many call sites, add `BeforeValidator` coercion on the affected model fields. Do NOT relax `strict=True` globally — that was a deliberate Phase 2 decision.
