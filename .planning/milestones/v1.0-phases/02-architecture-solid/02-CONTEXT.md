...
- `.sisyphus/plans/pydantic-v2-advanced-modernization.md` — u.Field() migration (1,551 usages), ABC audit (19 ABCs: 6 pure, 8 template, 5 retain), TypeAdapter audit (451 matches, ~100 inline), mutable defaults (13), dispatcher hot-path
...
- `u.PrivateAttr()` (94 usages) is NOT in scope for u.Field() migration — it's a different pattern.
