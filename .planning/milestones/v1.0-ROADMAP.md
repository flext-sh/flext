...
**Success Criteria** (what must be TRUE):
  ...
  3. All ~1,551 `Field(...)` usages use `Annotated[X, m.Field(...)]` canonical Pydantic v2 form
...
- [x] 02-03-PLAN.md — m.Field()->Annotated migration + mutable defaults fix (all 33 projects)
