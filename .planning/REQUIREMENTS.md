...
- [x] **ARCH-01**: All public API type annotations use protocol types (`p.Context`, `p.DI`, `p.Config`, `p.StructlogLogger`) not concrete types (`FlextContext`, `FlextContainer`, etc.)
