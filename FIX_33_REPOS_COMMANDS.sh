...
# client-a-oud-mig
if [ -f "client-a-oud-mig/.env" ]; then
    echo "❌ Removendo .env do client-a-oud-mig..."
    rm -f client-a-oud-mig/.env
    rm -f client-a-oud-mig/.env.bak
    rm -f client-a-oud-mig/.env.test
fi
