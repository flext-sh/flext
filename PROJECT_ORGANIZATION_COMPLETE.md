...
./flx migration status client-a-oud     # Status da migração client-a
./flx migration run client-a-oud        # Executar migração client-a
./flx migration run client-b         # Executar migração client-b
...
| `cd client-a-oud-mig && python analyze_hierarchy_errors.py` | `./flx migration run client-a-oud` |
| `cd client-b-meltano-native && python production_meltano_test.py` | `./flx migration run client-b` |
