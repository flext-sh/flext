...
def verify_user_loaded(
    conn: Connection, uid: str, base_dn: str = "dc=target,dc=com"
) -> bool:
...
def verify_group_loaded(
    conn: Connection, cn: str, base_dn: str = "dc=target,dc=com"
) -> bool:
...
def count_entries(
    conn: Connection, search_filter: str, base_dn: str = "dc=target,dc=com"
) -> int:
