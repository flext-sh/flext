...
| `gruponos-poc-oic-wms` | Hyphen in name | `gruponos_oic_wms` | **CRITICAL** |
| `algar-mig-oud` | Hyphen + abbreviation | `algar_oud_migration` | **HIGH** |
...
| `alg-ldap` | Abbreviation + hyphen | `algar_ldap` | **MEDIUM** |
...
| `gn-oic` | Abbreviation + hyphen | `gruponos_oic` | **MEDIUM** |
...
/pyauto/algar-mig-oud/docs/      # Empty, should be integrated
...
/pyauto/gruponos-poc-oic-wms/docs/ # Project docs, should be integrated
```
...
1. **Rename all hyphenated packages**
   ...
   gruponos-poc-oic-wms → gruponos_oic_wms
   ```
