...
./flx migration status client-a-oud       # Check status
./flx migration run client-a-oud          # Execute migration
./flx migration run client-a-oud --dry-run # Preview changes

./flx migration status client-b        # client-b status
./flx migration run client-b           # Execute client-b migration
...
| Old Script | New Command | Description |
|------------|-------------|-------------|
| `analyze_hierarchy_errors.py` | `./flx migration run client-a-oud` | client-a migration step 1 |
| `create_missing_parents.py` | `./flx migration run client-a-oud` | client-a migration step 2 |
| `complete_groups_migration.py` | `./flx migration run client-a-oud` | client-a migration step 3 |
| `production_meltano_test.py` | `./flx migration run client-b` | client-b extraction |
| `validate_100_percent_real.py` | `./flx migration run client-b` | client-b validation |
...
./flx migration status client-a-oud
