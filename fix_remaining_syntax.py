    ...
    for py_file in Path("legacy").rglob("*.py"):
        try:
            ...
            if content != original_content:
                ...
                print(f"✅ Fixed import syntax in {py_file}")
...
def fix_function_call_syntax():
    ...
    for file_path in files_to_fix:
        ...
        if path.exists():
            ...
            print(f"✅ Fixed function calls in {file_path}")
...
'''
            ...
            print(f"✅ Added validate_test_coverage function to {file_path}")
...
def main():
    ...
    print("🔧 Fixing function call syntax...")
