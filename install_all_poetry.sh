...
# Lista de projetos
PROJECTS="flx flx-database-oracle flx-http-oracle-oic flx-http-oracle-wms algar-mig-oud gruponos-poc-oic-wms flx-adapter-example"
...
try:
    import algar_oud_mig
    print('✅ algar_oud_mig importado')
except Exception as e:
    print(f'❌ algar_oud_mig: {e}')
