...
✅ **algar-oud-mig**: Oracle Unified Directory migration tool (functional but depends on unstable core)  
...
2. **[ ] Dependency Chain Validation**
   - Test that algar-oud-mig works with refactored flext-core
...
6. **[ ] LDAP/LDIF Integration**
   - flext-ldap: Verify and improve based on algar-oud-mig needs
