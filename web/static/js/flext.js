...
function updateDashboardStats(pipelinesData, pluginsData, healthData) {
  const pipelineCount = pipelinesData.pipelines
...
function loadRecentActivity() {
  ...
  const activities = [
    {
      time: "2 minutes ago",
      action: 'Pipeline "Data ETL" completed successfully',
      type: "success",
    },
    {
      time: "5 minutes ago",
      action: 'Plugin "Oracle Connector" registered',
      type: "info",
    },
    {
      time: "10 minutes ago",
      action: 'Pipeline "Log Processing" started',
      type: "info",
    },
    {
      time: "15 minutes ago",
...
function createPipeline() {
  const modal = new bootstrap.Modal(
    document.getElementById("createPipelineModal"),
  );
  modal.show();
}
...
function registerPlugin() {
  const modal = new bootstrap.Modal(
    document.getElementById("registerPluginModal"),
  );
  modal.show();
}
...
function viewPlugin(id) {
  ...
  const modal = new bootstrap.Modal(
    document.getElementById("pluginDetailModal"),
  );
  modal.show();
...
function updateMonitoringStats(metricsText, healthData) {
  ...
  document.getElementById("memory-usage").textContent =
    Math.floor(Math.random() * 100) + "%";
  document.getElementById("active-connections").textContent = Math.floor(
    Math.random() * 50,
  );
  ...
  document.getElementById("network-progress").style.width =
    networkPercent + "%";
}
...
function loadSystemLogs() {
  ...
  const logs = [
    {
      timestamp: "2025-06-30 15:30:45",
      level: "INFO",
      component: "API",
      message: "Server started successfully",
    },
    {
      timestamp: "2025-06-30 15:30:46",
      level: "INFO",
      component: "DB",
      message: "Database connection established",
    },
    {
      timestamp: "2025-06-30 15:30:47",
      level: "WARN",
      component: "PLUGIN",
      message: "Plugin initialization took longer than expected",
    },
    {
      timestamp: "2025-06-30 15:30:48",
      level: "INFO",
      component: "PIPELINE",
      message: "Pipeline executor initialized",
    },
  ];
