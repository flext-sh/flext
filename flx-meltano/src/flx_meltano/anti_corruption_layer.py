...
class MeltanoAdapter(ABC):
    ...
    async def run_pipeline(
        self, tap_name: str, target_name: str, configuration: ConfigurationDict | None = None
    ) -> MeltanoRunResult:
    ...
    @abstractmethod
    async def set_plugin_config(self, plugin_name: str, config: ConfigurationDict) -> bool:
...
class MeltanoAntiCorruptionLayer:
    ...
    def _translate_plugin_to_meltano(self, domain_plugin: Plugin) -> MeltanoPluginDescriptor:
    ...
    def _translate_meltano_to_plugin(self, meltano_plugin: MeltanoPluginDescriptor) -> Plugin:
    ...
    def _translate_pipeline_config(self, pipeline: Pipeline, execution: PipelineExecution) -> ConfigurationDict:
...
class MeltanoEngineAdapter(MeltanoAdapter):
    ...
    async def run_pipeline(
        self, tap_name: str, target_name: str, _configuration: ConfigurationDict | None = None
    ) -> MeltanoRunResult:
    ...
    async def set_plugin_config(self, _plugin_name: str, _config: ConfigurationDict) -> bool:
