...
class TestLDAPObjectClass:
    ...
    def test_standard_object_classes(self):
    ...
    def test_oracle_specific_classes(self):
...
class TestDNComponent:
    ...
    def test_escaping_in_string_representation(self):
...
class TestLdapDn:
    ...
    def test_simple_dn_creation(self):
    ...
    def test_empty_dn_validation(self):
    ...
    def test_invalid_dn_format(self):
    ...
    def test_get_parent_dn_single_component(self):
    ...
    def test_replace_base_dn_invalid(self):
...
class TestConnectionProfile:
    ...
    def test_ldap_url_generation(self):
...
class TestSchemaAnalysisResult:
    ...
    def test_requires_mapping_schema(self):
...
class TestMigrationPlan:
    ...
    def create_test_schema_analysis(self, compatibility=SchemaCompatibility.FULL):
    ...
    def test_empty_phases_validation(self):
    ...
    def test_incompatible_schema_validation(self):
    ...
    def test_ready_for_execution_with_rules(self):
