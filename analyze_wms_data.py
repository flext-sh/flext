    ...
    for entity in entities_to_analyze:
        ...
        try:
            ...
            if complex_analysis["object_fields"]:
                for field in complex_analysis["object_fields"]:
                    pass

            # Mostrar campos array detalhadamente
            if complex_analysis["array_fields"]:
                for field in complex_analysis["array_fields"]:
                    pass
            ...
            complex_patterns = {k: v for k, v in all_types.items() if len(v) > 1 or any(t in {"dict", "list"} for t in v)}
