...
class UsersStream(LDAPStream):
    ...
    schema: ClassVar[dict[str, Any]] = th.PropertiesList(
        ...
        th.Property(
            "modifyTimestamp", th.DateTimeType, description="Last Modified Time"
        ),
    ).to_dict()
...
class GroupsStream(LDAPStream):
    ...
    schema: ClassVar[dict[str, Any]] = th.PropertiesList(
        ...
        th.Property(
            "memberUid", th.ArrayType(th.StringType), description="Member UIDs"
        ),
        th.Property(
            "objectClass", th.ArrayType(th.StringType), description="Object Classes"
        ),
...
class SchemaStream(LDAPStream):
    ...
    schema: ClassVar[dict[str, Any]] = th.PropertiesList(
        ...
        th.Property(
            "extracted_at", th.DateTimeType, description="Extraction Timestamp"
        ),
    ).to_dict()
