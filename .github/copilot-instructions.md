...
- If the selected smell is stale or already gone, rerun `qlty` immediately and keep the same local anchor.
- Single-caller private helper -> inline delete; do not replace it with a new model, helper, or wrapper.
